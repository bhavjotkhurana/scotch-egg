...
\]
The corner point is \((4,2)\), the intersection of both boundaries. Since the first boundary is strict \(>\), \((4,2)\) is not included in the solution set.
...
\begin{enumerate}
  ...
  For \(x<-1.5\), \(-x\) exceeds \(3x+6\), so no valid \(y\) exists there — the region only extends from \(x=-1.5\) to \(x=5\).
  Vertices: \((-1.5,1.5), (5,-5), (5,21)\). Bounded (triangle).
...
\ReflectionPage{Unit 2, Topic 5: Modeling Real World Problems with Systems}{https://www.scotchegg.co}
