...
\begin{enumerate}
    ...
    \item The sum of the digits of a two-digit number is 12. The number is 18 more than 8 times the tens digit. Find the number.
\end{enumerate}
...
\begin{enumerate}
    ...
    \(L = 2(\tfrac{20}{3}) + 4 = \tfrac{40}{3} + \tfrac{12}{3} = \tfrac{52}{3}\).
    \(\boxed{W = \tfrac{20}{3}, L = \tfrac{52}{3}}\)
    ...
    \(t + u = 12\), \(10t + u = 8t + 18\).
    Substitute \(u = 12 - t\): \(10t + 12 - t = 8t + 18 \Rightarrow 9t + 12 = 8t + 18 \Rightarrow t = 6\).
    Then \(u = 12 - 6 = 6\).
    \(\boxed{66}\)
\end{enumerate}
...
\ReflectionPage{Unit 2, Topic 2: Solving Systems by Elimination}{https://www.scotchegg.co}
