...
\begin{enumerate}
  ...
  \item The ratio of boys to girls in a class is \(3:5\). If there are 35 girls, how many boys are there?
...
\begin{enumerate}
  ...
  \item In a certain alloy, the ratio of copper to zinc is \(5:3\). If 40 grams of copper are added and the ratio becomes \(5:2\), how much zinc was originally present?
...
\begin{enumerate}
  ...
  \item \(3:5=\dfrac{b}{35} \Rightarrow 5b=105 \Rightarrow \boxed{b=21}\)
...
\begin{enumerate}
  ...
  \item Initial \(c:z=5:3=5k:3k\). After adding 40 g copper: \(\dfrac{5k+40}{3k}=\dfrac{5}{2}\) gives \(10k+80=15k \Rightarrow 5k=80 \Rightarrow k=16\).
  \(\boxed{z=3k=48\text{ g}}\)
...
\ReflectionPage{Unit 3, Topic 2: Unit Rate and Proportional Relationships}{https://www.scotchegg.co}
