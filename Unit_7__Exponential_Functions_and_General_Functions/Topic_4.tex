...
Range: for \(x < 0\), \(x+2\) covers \((-\infty, 2)\); for \(x \ge 0\), \(x^2\) covers \([0, \infty)\). Together these two intervals cover every real number.

\[
\boxed{\text{Domain: all real, Range: all real numbers.}}
\]
...
\ReflectionPage{Unit 7, Topic 5: Composition and Inverses of Functions}{https://www.scotchegg.co}
