...
After 3 years:
\[
V = 30{,}000(0.85)^3 = 30{,}000(0.614125) = 18{,}423.75.
\]
\(\boxed{V = \$18{,}423.75}\)
...
A growth curve (\(b > 1\)) rises rapidly to the right, while a decay curve (\(0 < b < 1\)) decreases toward 0.
...
\ReflectionPage{Unit 7, Topic 2: Comparing Linear and Exponential Growth}{https://www.scotchegg.co}
