...
The graph below shows a base function \(f(x) = x^2\) alongside two transformations of it: \(f(x - 3)\), a horizontal shift, and \(-f(x)\), a reflection over the \(x\)-axis. Seeing all three together makes it clear that a transformation moves or flips the whole shape without changing it.
...
\begin{diagramdata}
{
  ...
  "xMax": 6,
  "series": [
    {"label": "f(x) = x²", "fn": "x*x", "color": "#1E3A2F", "dash": false},
    {"label": "f(x - 3)", "fn": "(x-3)*(x-3)", "color": "#B08840", "dash": true},
    {"label": "-f(x)", "fn": "-(x*x)", "color": "#B0453E", "dash": true}
  ]
}
\end{diagramdata}
...
\ReflectionPage{Unit 8, Topic 1: Lines and Angles — Parallel, Perpendicular, and Transversals}{https://www.scotchegg.co}
