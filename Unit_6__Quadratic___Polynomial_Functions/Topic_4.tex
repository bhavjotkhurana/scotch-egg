...
For \(y = x^2 - 4x + 3\), these features look like this:
...
A parabola is defined by \(y = x^2 - 4x + 3\).
\begin{enumerate}
  \setcounter{enumi}{15}
  \item What is the vertex of this parabola?
...
\ReflectionPage{Unit 6, Topic 5: Adding, Subtracting, and Multiplying Polynomials}{https://www.scotchegg.co}
