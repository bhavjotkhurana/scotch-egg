...
\begin{diagramdata}
{
  ...
  "xMax": 6,
  "series": [
    {"label": "Narrow (small SD)", "fn": "Math.exp(-(x*x)/2)", "color": "#1E3A2F", "dash": false},
    {"label": "Wide (large SD)", "fn": "Math.exp(-(x*x)/12.5)", "color": "#B08840", "dash": true}
  ]
}
\end{diagramdata}
...
\begin{enumerate}
  \setcounter{enumi}{10}
  \item Two bell curves have the same mean. Curve A is narrower, and Curve B is wider.
  \begin{diagramdata}
  {
    "type": "function-comparison",
    "xMin": -6,
    "xMax": 6,
    "series": [
      {"label": "Curve A", "fn": "Math.exp(-(x*x)/2)", "color": "#1E3A2F", "dash": false},
      {"label": "Curve B", "fn": "Math.exp(-(x*x)/12.5)", "color": "#B08840", "dash": true}
    ]
  }
  \end{diagramdata}
  Which has the larger SD, and why?
  \item A histogram shows that most data values are close to the mean.
  \begin{diagramdata}
  {
    "type": "bar-chart",
    "xLabel": "Value bin",
    ...
    "series": [
      {"label": "Frequency", "color": "#1E3A2F", "values": [2, 5, 12, 20, 12, 5, 2]}
    ]
  }
  \end{diagramdata}
  What does that say about SD?
...
\ReflectionPage{Unit 4, Topic 7: Interpreting Trend Lines and Regression (Conceptual)}{https://www.scotchegg.co}
