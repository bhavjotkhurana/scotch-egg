  ...
  "branches": [
    {
      ...
      "probability": 0.3,
      "children": [
        {"label": "Jam", "probability": 0.5},
        {"label": "No Jam", "probability": 0.5}
      ]
    },
    {
      "label": "No Rain",
      "probability": 0.7,
      "children": [
        {"label": "Jam", "probability": 0.2},
        {"label": "No Jam", "probability": 0.8}
      ]
    }
  ]
}
  ...
  "branches": [
    {
      ...
      "probability": 0.90,
      "children": [
        {"label": "Pass", "probability": 0.95},
        {"label": "Fail", "probability": 0.05}
      ]
    },
    {
      "label": "Defective",
      "probability": 0.10,
      "children": [
        {"label": "Fail", "probability": 0.80},
        {"label": "Pass", "probability": 0.20}
      ]
    }
  ]
}
...
\begin{enumerate}
  \setcounter{enumi}{10}
  \item Draw a tree diagram to represent the situation. \DiagramAfterReveal
...
\begin{enumerate}
  \setcounter{enumi}{10}
  \item The tree branches first into Good (\(0.90\)) and Defective (\(0.10\)), then each of those branches into Pass and Fail using the given conditional probabilities, as shown above.
...
\ReflectionPage{Unit 4, Topic 6: Understanding Variability and Standard Deviation (Conceptual)}{https://www.scotchegg.co}
