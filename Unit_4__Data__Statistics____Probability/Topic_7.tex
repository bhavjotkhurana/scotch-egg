...
\begin{enumerate}
  ...
  \item The line \(\hat{y} = -2x + 100\) models test score vs. absences. What does the slope mean here?
  \begin{diagramdata}
  {
    "type": "trend-line",
    "xLabel": "Absences",
...
\begin{enumerate}
  ...
  \item Each additional absence decreases predicted test score by 2 points.
